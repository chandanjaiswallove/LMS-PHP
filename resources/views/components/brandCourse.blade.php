                            ...
                            <div class="swiper-wrapper">
                                ...
                                <div class="swiper-slide">
                                    <div class="brand-area">
                                        <img src="{{ asset('assets/images/brand/08.svg')}}" alt="brand">
                                    </div>
                                </div>
                                <!-- single swiper style -->
                                <!-- single swiper style -->
                                <div class="swiper-slide">
                                    <div class="brand-area">
                                        <img src="{{ asset('assets/images/brand/09.svg')}}" alt="brand">
                                    </div>
                                </div>
                                <!-- single swiper style -->
                                <!-- single swiper style -->
                                <div class="swiper-slide">
                                    <div class="brand-area">
                                        <img src="{{ asset('assets/images/brand/10.svg')}}" alt="brand">
                                    </div>
                                </div>
                                <!-- single swiper style -->
                                <!-- single swiper style -->
                                <div class="swiper-slide">
                                    <div class="brand-area">
                                        <img src="{{ asset('assets/images/brand/11.svg')}}" alt="brand">
                                    </div>
                                </div>
                                <!-- single swiper style -->
                                <!-- single swiper style -->
                                <div class="swiper-slide">
                                    <div class="brand-area">
                                        <img src="{{ asset('assets/images/brand/12.svg')}}" alt="brand">
                                    </div>
                                </div>
                                <!-- single swiper style -->
                                <!-- single swiper style -->
                                <div class="swiper-slide">
                                    <div class="brand-area">
                                        <img src="{{ asset('assets/images/brand/13.svg')}}" alt="brand">
                                    </div>
                                </div>
                                <!-- single swiper style -->
                            </div>
    ...
    <!-- home main showcase course about area start -->
    <div class="about-area-start rts-section-gapBottom">
                ...
                <div class="col-xl-6 col-lg-12">
                    ...
                    <div class="about-one-left-image">
                        <div class="first-order">
                            <div class="thumb-one">
                                <img src="{{ asset('assets/images/about/03.jpg')}}" alt="about">
                    ...
                    <div class="about-inner-right-one">
                        <div class="what-you-get">
                            ...
                            <div class="single-facilityes">
                                <div class="icon">
                                    <img src="{{ asset('assets/images/about/icon/01.png')}}" alt="icon-image">
                                </div>
                                <div class="information">
                            ...
                            <div class="single-facilityes">
                                <div class="icon">
                                    <img src="{{ asset('assets/images/about/icon/02.png')}}" alt="icon-image">
                                </div>
                                <div class="information">
        ...
        <!-- home main showcase course about area end  -->
