                                    ...
                                    <ul class="rts-dropdown-menu switcher-language">
                                        <li class="has-child-menu">
                                            <a href="index-six.html#">
                                                <img class="left-image" src="{{ asset('assets/images/flag-01.svg')}}" alt="Language Images">
                                            ...
                                            <ul class="sub-menu">
                                                <li>
                                                    <a href="index-six.html#">
                                                        <img class="left-image" src="{{ asset('assets/images/flag-03.svg')}}" alt="Language Images">
                                                        <span class="menu-item">Deutsch</span>
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="index-six.html#">
                                                        <img class="left-image" src="{{ asset('assets/images/flag-02.svg')}}" alt="Language Images">
                                                        <span class="menu-item">Portuguese</span>
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="index-six.html#">
                                                        <img class="left-image" src="{{ asset('assets/images/flag-04.svg')}}" alt="Language Images">
                                ...
                                <nav>
                                    <ul>
                                        <li class="has-dropdown" style="position: static;">
                                            <a class="nav-link" href="index-six.html#">Home</a>
                                            ...
                                            <ul class="megamenu-hub">
                                                <li>
                                                    ...
                                                    <div class="absolute-image-shape shape-image">
                                                        <img class=" shape one" src="{{ asset('assets/images/nav/02.png')}}" data-speed="0.04" data-revert="true" alt="nav">
                                                        <img class=" shape two" src="{{ asset('assets/images/nav/03.png')}}" data-speed="0.04" alt="nav">
                                                    </div>
                                                    <div class="nav-mega-image">
                                                        <a href="single-course.html">
                                                            <img src="{{ asset('assets/images/nav/01.jpg')}}" alt="nav">
                                                        </a>
                                                    </div>
                                                </li>
                                            </ul>
                                        ...
                                        <li class="has-dropdown">
                                            <a class="nav-link" href="index-six.html#">Pages</a>
                                            <ul class="submenu">
                                        ...
                                        <li class="has-dropdown" style="position: static;">
                                            <a class="nav-link" href="index-six.html#">Courses</a>
                                            <ul class="megamenu-hub min-mega shape-move">
                                                <li>
                                                    <ul class="">
                                                        <li class="parent"><a href="index-six.html#">Courses</a></li>
                                                    ...
                                                    <ul class="">
                                                        <li class="parent"><a href="index-six.html#">Courses Details</a></li>
                                                    ...
                                                    <ul class="">
                                                        <li class="parent"><a href="index-six.html#">Others</a></li>
                                                    ...
                                                    <div class="thumbnav-area">
                                                        ...
                                                        <a href="create-course.html" class="single-thumbnav">
                                                            <div class="icon">
                                                                <img src="{{ asset('assets/images/nav/04.png')}}" alt="nav">
                                                            </div>
                                                        ...
                                                        <a href="lesson-details.html" class="single-thumbnav mash">
                                                            <div class="icon">
                                                                <img src="{{ asset('assets/images/nav/05.png')}}" alt="nav">
                                                            </div>
                                                        ...
                                                        <a href="instructor.html" class="single-thumbnav">
                                                            <div class="icon">
                                                                <img src="{{ asset('assets/images/nav/06.png')}}" alt="nav">
                                                            </div>
                                        ...
                                        <li class="has-dropdown">
                                            <a class="nav-link" href="index-six.html#">Dashboard</a>
                                            <ul class="submenu">
                                                <li class="sub-dropdown">
                                        ...
                                        <li class="has-dropdown">
                                            <a class="nav-link" href="index-six.html#">Blog</a>
                                            <ul class="submenu">
            ...
            <div class="product-item">
                ...
                <div class="cart-edit">
                    ...
                    <div class="item-wrapper d-flex mr--5 align-items-center">
                        <a href="index-six.html#" class="product-edit"><i class="fal fa-edit"></i></a>
                        <a href="index-six.html#" class="delete-cart"><i class="fal fa-times"></i></a>
                    </div>
                </div>
            </div>
            <div class="product-item">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="index-six.html#" class="login-form">
        ...
        <div class="mobile-menu-main">
            <nav class="nav-main mainmenu-nav mt--30">
                <ul class="mainmenu metismenu" id="mobile-menu-active">
                    ...
                    <li class="has-droupdown">
                        ...
                        <ul class="submenu mm-collapse">
                            ...
                            <li class="has-droupdown third-lvl">
                                <a class="main" href="index-six.html#">Zoom</a>
                            ...
                            <li class="has-droupdown third-lvl">
                                <a class="main" href="index-six.html#">Event</a>
                                <ul class="submenu-third-lvl mm-collapse">
                            ...
                            <li class="has-droupdown third-lvl">
                                <a class="main" href="index-six.html#">Shop</a>
                                <ul class="submenu-third-lvl mm-collapse">
                    ...
                    <li class="has-droupdown">
                        <a href="index-six.html#" class="main">Course</a>
                        <ul class="submenu mm-collapse">
                            <li><a href="index-six.html#" class="tag">Courses</a></li>
                            <li><a class="mobile-menu-link" href="course-one.html">Courses</a></li>
                            <li><a class="mobile-menu-link" href="course-two.html">Course List</a></li>
                            <li><a class="mobile-menu-link" href="course-three.html">Course Grid</a></li>
                            <li><a class="mobile-menu-link" href="course-four.html">Course List Two</a></li>
                        ...
                        <ul class="submenu mm-collapse">
                            <li><a href="index-six.html#" class="tag">Courses Details</a></li>
                        ...
                        <ul class="submenu mm-collapse">
                            <li><a href="index-six.html#" class="tag">Others</a></li>
                    ...
                    <li class="has-droupdown">
                        <a href="index-six.html#" class="main">Dashboard</a>
                        <ul class="submenu mm-collapse">
                            <li class="has-droupdown third-lvl">
                                <a class="main" href="index-six.html#">Instructor Dashboard</a>
                                <ul class="submenu-third-lvl mm-collapse">
                            ...
                            <li class="has-droupdown third-lvl">
                                <a class="main" href="index-six.html#">Students Dashboard</a>
                                <ul class="submenu-third-lvl mm-collapse">
                    ...
                    <li class="has-droupdown">
                        <a href="index-six.html#" class="main">Blog</a>
                        <ul class="submenu mm-collapse">
            ...
            <div class="buttons-area">
                <a href="index-six.html#" class="rts-btn btn-border">Log In</a>
                <a href="index-six.html#" class="rts-btn btn-primary">Sign Up</a>
            </div>
