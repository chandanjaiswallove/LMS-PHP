                ...
                <div class="col-lg-12">
                    <div class="call-to-sction bg_image shape-move">
                        ...
                        <div class="shape-image">
                            <div class="shape one" data-speed="0.04"><img src="{{asset('assets/images/cta/03.svg')}}" alt=""></div>
                            <div class="shape two" data-speed="0.04"><img src="{{asset('assets/images/cta/04.svg')}}" alt=""></div>
                        </div>
                    </div>
                </div>
            </div>
