                ...
                <div class="col-lg-12">
                    <div class="fun-facts-main-wrapper-1">
                        ...
                        <div class="single-fun-facts">
                            <div class="icon">
                                <img src="{{ asset('assets/images/fun-facts/01.svg')}}" alt="icon">
                            </div>
                        ...
                        <div class="single-fun-facts">
                            <div class="icon">
                                <img src="{{ asset('assets/images/fun-facts/02.svg')}}" alt="icon">
                            </div>
                        ...
                        <div class="single-fun-facts">
                            <div class="icon">
                                <img src="{{ asset('assets/images/fun-facts/03.svg')}}" alt="icon">
                            </div>
                        ...
                        <div class="single-fun-facts">
                            <div class="icon">
                                <img src="{{ asset('assets/images/fun-facts/04.svg')}}" alt="icon">
                            </div>
