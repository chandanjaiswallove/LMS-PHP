    ...
    <div class="banner-area-one shape-move">
                            ...
                            <div class="banner-btn-author-wrapper">
                                ...
                                <div class="sm-image-wrapper">
                                    <div class="images-wrap">
                                        <img src="{{ asset('assets/images/banner/shape/06.png')}}" alt="banner">
                                        <img class="two" src="{{ asset('assets/images/banner/shape/07.png')}}" alt="banner">
                                        <img class="three" src="{{ asset('assets/images/banner/shape/08.png')}}" alt="banner">
                                    </div>
                                    <div class="info">
        ...
        <div class="review-thumb">
            ...
            <div class="review-single">
                <img src="{{ asset('assets/images/banner/03.png')}}" alt="banner">
            ...
            <div class="review-single two">
                <img src="{{ asset('assets/images/banner/04.png')}}" alt="banner">
                <div class="info-right">
                    <h6 class="title">100+
                    </h6>
        ...
        <div class="shape-image">
            <div class="shape one" data-speed="0.04" data-revert="true"><img src="{{ asset('assets/images/banner/shape/banner-shape01.svg')}}" alt="shape_image"></div>
            <div class="shape two" data-speed="0.04"><img src="{{ asset('assets/images/banner/shape/banner-shape02.svg')}}" alt="shape_image"></div>
            <div class="shape three" data-speed="0.04"><img src="{{ asset('assets/images/banner/shape/banner-shape03.svg')}}" alt="shape_image"></div>
        </div>
    </div>
