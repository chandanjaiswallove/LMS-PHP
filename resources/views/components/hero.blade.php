...
<body>
                                ...
                                <div class="col-lg-6 col-xl-6 col-md-8 col-sm-9">
                                    <div class="rts-slider">
                                        <div class="rts-slider-content">
                                            <h6 class="rts-subtitle"><img src="{{ asset('assets2/images/icon/e-cap.svg') }}" alt="education hat"> knowledge meets innovation</h6>
  ...
  ">
    <i class="fa-thin fa-arrow-right"></i>
                        ...
                        <div class="rts-slider-bg" data-background="{{ asset('assets2/images/banner/02-01.jpg') }}" style="background-image: url('{{ asset('assets2/images/banner/02-01.jpg')}}') "></div>
                        <div class="container">
                            <div class="row justify-content-lg-center justify-content-xl-start">
                                <div class="col-lg-6 col-xl-6 col-md-8 col-sm-9">
                                    <div class="rts-slider">
  ...
  ">
    <i class="fa-thin fa-arrow-right"></i>
                        ...
                        <div class="rts-slider-bg" data-background="{{ asset('assets2/images/banner/02-01.jpg') }}" style="background-image: url('{{ asset('assets2/images/banner/02-03.jpg')}}') "></div>
                        <div class="container">
                            <div class="row justify-content-lg-center justify-content-xl-start">
                                <div class="col-lg-6 col-xl-6 col-md-8 col-sm-9">
                                    <div class="rts-slider">
